...
// ==========================================================================
// 4. ANWENDUNGSSTATUS & INITIALISIERUNG
// ==========================================================================
...
window.addEventListener("DOMContentLoaded", () => {
    // 1. Lade statistische Werte aus dem LocalStorage
    loadStats();
    
    // 2. Initialisiere Lückentrainer
    initTrainerRound();
    
    // 3. Initialisiere unregelmäßige Verben Sidebar Widget
    initWidgetVerb();
    
    // 4. Rendere Grammatik-Erklärungen
    renderGrammarCards();

    // Key-Listener für Enter im Lückentrainer
...
// ==========================================================================
// 6. INTERAKTIVER SATZ-TRAINER (LOGIK)
// ==========================================================================
function initTrainerRound() {
    // 10 zufällige Sätze aus der Bank ziehen
...
function loadSentence() {
    ...
    // Instruktionen auf Schritt 1 setzen
...
function renderSentenceWithTokens() {
    ...
    // Teilt den Satz an der Lücke "_____" auf
    const parts = activeSentence.text.split("_____");
    
    // 1. Text vor der Lücke
...
function showRoundResults() {
    ...
    container.innerHTML = `
        <div class="round-summary" style="text-align: center; padding: 20px; animation: popIn 0.5s ease;">
            ...
            <p style="color: var(--text-muted); font-size: 0.9em;">Glückwunsch! Du hast dadurch ${sentenceScore * 10} Punkte gesammelt.</p>
            <button class="btn btn-accent" style="margin-top: 20px;" onclick="initTrainerRound()">
                <i class="fa-solid fa-arrows-rotate"></i> Neue Runde starten
            </button>
        </div>
    `;

    // Action Button ausblenden/sperren
    const btnAction = document.getElementById("btn-action");
    btnAction.disabled = true;
